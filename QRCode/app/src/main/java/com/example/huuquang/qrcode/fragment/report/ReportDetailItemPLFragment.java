...
public class ReportDetailItemPLFragment extends Fragment {
    ...
    private DatabaseReference transactionRef, itemRef;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String pl = searchEditText.getText().toString();
                if(pl.trim().isEmpty()) return;
                transactionRef.orderByChild("pl").equalTo(pl).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                                ...
                                itemRef.orderByKey().equalTo(transaction.getItem_id()).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        if(dataSnapshot.hasChildren() && dataSnapshot.getChildrenCount() == 1){
                                            ...
                                            Item item = new Item();
                                            item.setId(transaction.getItem_id());
                                            adapter.add(transaction, item);
                                        }
                                    }
        ...
        toCSV2Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(file != null){
                    ...
                    Log.d(ReportDetailItemPLFragment.this.getClass().getSimpleName(), uri.toString());
    ...
    private File saveFile(){
        String pl = adapter.getList().get(0).getTransaction().getPl();
        List<String> lines = toCSV();

        File file = new File(getActivity().getExternalFilesDir(null), pl + ".csv");
