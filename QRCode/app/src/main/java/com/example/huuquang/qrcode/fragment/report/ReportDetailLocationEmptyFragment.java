...
public class ReportDetailLocationEmptyFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mTitleTextView.setText("Vị Trí - Trống");
        ...
        locationListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                String locationId = dataSnapshot.getKey();
                final Location location = dataSnapshot.getValue(Location.class);
                location.setId(locationId);
                itemLocationRef.orderByChild("location_id").equalTo(locationId).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
